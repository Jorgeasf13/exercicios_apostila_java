...
public class telaGenio extends javax.swing.JFrame {
    ...
    public telaGenio() {  //CONSTRUTOR
        ...
        lblFrase.setText("<html>Vou pensar em um valor entre <strong> 1 e 5</strong>, tente adivinhar qual é!</html>");
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/baixados.jpg"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 210, -1, 152));
        ...
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 40, 160, 100));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/balao.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 254, -1));
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 270, 50, 30));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, 110, -1));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        String f1 = "ACERTÔ MIZERAVI!";
        String f2 = "<html>ERRRRRROOOOOU! O valor é " + valor + " </html>";
