...
// O INTELLIJ ADICIONOU ESSA CLASSE
import java.awt.*;
...
public class IdiomaResolucao extends javax.swing.JFrame {
    ...
    private void btnClickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClickActionPerformed
        ...
        String textoLabel = "";
        // Pegando o ambiente gráfico
        GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
        // Em caso de erro sair da função
        if (ge == null) {
            //log.info("GraphicsEnvironment return is NULL");
            return;
        }
        // Pegando todos os monitores
        GraphicsDevice[] gs = ge.getScreenDevices();
        // Para cada monitor
        for (int i = 0; i < gs.length; i++) {
            // Pegando modo de display atual
            DisplayMode dm = gs[i].getDisplayMode();
            // Em caso de erro sair da função
            if (dm == null) {
                //log.info("DisplayMode return is NULL");
                return;
            }
            // Adicionando mais um monitor
            textoLabel += "Monitor: " + i + ", resolução: " + dm.getWidth() + "x" + dm.getHeight() + ". \n";
        }
        // Adicionando idioma
        Locale loc = Locale.getDefault();
        textoLabel += "Idioma: " + loc;

        // Escrevendo na tela
        lblTexto.setText(textoLabel);

        /*
        Toolkit tk = Toolkit.getDefaultToolkit();
        Dimension d = tk.getScreenSize();
        lblTexto.setText("A resolução é "+d.width + " x " +d.height +" e o );
        */
