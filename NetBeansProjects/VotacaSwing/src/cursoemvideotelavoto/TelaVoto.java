...
public class TelaVoto extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(43, 43, 43)
                        .addComponent(lblIdade, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnVotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotoActionPerformed
        ...
        if(idade<16){
            ...
            lblIdade.setText(String.format(idade + " "+"anos"));
        }else{
            if((idade>=16 && idade < 18) || (idade >= 70)){
                lblResultado.setText("Não obrigatório!");
                lblIdade.setText(String.format(idade + " "+"anos"));
            }else{
